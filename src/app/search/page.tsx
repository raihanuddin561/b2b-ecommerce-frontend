...
export default function SearchPage() {
  ...
  const displayedProducts = searchResults.slice(startIndex, startIndex + productsPerPage);
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {query && searchResults.length > 0 && (
          <>
            <div className="mb-6">
              <p className="text-gray-600">
                Showing {startIndex + 1}-{Math.min(startIndex + productsPerPage, searchResults.length)} of {searchResults.length} results
              </p>
            </div>
