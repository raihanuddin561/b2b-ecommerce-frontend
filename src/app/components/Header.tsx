  ...
  return (
    <header className="flex items-center justify-between p-4 border-b shadow-sm gap-4 flex-wrap bg-slate-100">
      ...
      <nav className="flex items-center gap-4 text-sm text-gray-700">
        ...
        <Link href="/compare" className="hover:text-blue-700 font-medium">Compare</Link>
        
        {/* Wishlist Icon */}
        <Link href="/wishlist" className="relative hover:text-blue-700 font-medium">
          ...
          {isAuthenticated ? (
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 hover:text-blue-700 font-medium"
              >
